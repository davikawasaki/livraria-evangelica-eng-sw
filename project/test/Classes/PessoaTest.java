...
public class PessoaTest {
    ...
    @Test
    public void testeIdPessoaValido() {
    ...
    @Test
    public void testeSenhaPessoaValido() throws Exception {
        Pessoa pessoa = new Pessoa();
    ...
    public void testGetSenhaInvalida2() {
        ...
        String expResult = "Senha Invalida";
        try{
            pessoa.setSenha("senhamuit0grande");
            String valorRecebido = pessoa.getSenha();
            fail("Deveria ter lançado uma exceção!");
        }
        catch(Exception e){
