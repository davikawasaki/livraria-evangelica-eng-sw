                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="hidden-sm hidden-xs action-buttons">
                                                                ...
                                                                <form action="DeletaCliente" id="submitDelete" method="POST" style="display: inline-block;">
                                                                    <a href="#" id="delete" onclick="document.getElementById('submitDelete').submit();" class="tooltip-error red ace-icon fa fa-trash-o bigger-130" data-rel="tooltip" title="Delete">
                                                                        <input name="delete" type="submit" value="${cliente.getPf().pessoa.id}" style="opacity: 0;">
                                                                    </a>
                                                                </form>
